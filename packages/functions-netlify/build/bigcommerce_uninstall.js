...
/******/ 	return __webpack_require__(__webpack_require__.s = "./bigcommerce_uninstall.ts");
/******/ })
/************************************************************************/
/******/ ({
...
exports.handler = async (event, context, callback) => {
  try {
    ...
    await _bigcommerce_app__WEBPACK_IMPORTED_MODULE_2__["repository"].deleteRecord(faunadbClient, payload.store_hash);
    return {
      statusCode: 200,
      body: JSON.stringify({
        "status": "success"
