...
/******/ 	return __webpack_require__(__webpack_require__.s = "./bigcommerce_auth.ts");
/******/ })
/************************************************************************/
/******/ ({
...
exports.handler = async (event, context, callback) => {
  try {
    const authorizationData = await bigCommerce.authorize(event.queryStringParameters);
    const storeData = {
    ...
    await _bigcommerce_app__WEBPACK_IMPORTED_MODULE_2__["repository"].createRecord(faunadbClient, storeData);
    return {
      statusCode: 302,
      headers: {
        'Access-Control-Allow-Origin': '*',
        'Cache-Control': 'no-cache',
        'Set-Cookie': _auth__WEBPACK_IMPORTED_MODULE_3__["auth"].generateCookie(storeData.store_hash, authorizationData.access_token),
