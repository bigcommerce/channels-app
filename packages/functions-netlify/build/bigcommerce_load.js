...
/******/ 	return __webpack_require__(__webpack_require__.s = "./bigcommerce_load.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./bigcommerce/app/index.ts":
/*!**********************************!*\
  !*** ./bigcommerce/app/index.ts ***!
  \**********************************/
/*! exports provided: models, repository, interfaces */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _repository__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./repository */ "./bigcommerce/app/repository.ts");
...
/* harmony import */ var _models__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./models */ "./bigcommerce/app/models.ts");
...
/* harmony import */ var _interfaces__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./interfaces */ "./bigcommerce/app/interfaces.ts");
...
/***/ "./bigcommerce/app/repository.ts":
/*!***************************************!*\
  !*** ./bigcommerce/app/repository.ts ***!
  \***************************************/
/*! exports provided: createRecord, fetchRecord, deleteRecord */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createRecord", function() { return createRecord; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fetchRecord", function() { return fetchRecord; });
...
async function createRecord(faunadbClient, storeData) {
  console.log(`Creating store app record for ... ${storeData.context}`);
  return faunadbClient.query(q.Create(q.Collection("bigcommerce_stores"), {
    data: storeData
  }));
}
async function fetchRecord(faunadbClient, storeHash) {
  console.log(`Fetching store app record for ... ${storeHash}`);
  const record = await faunadbClient.query(q.Get(q.Match(q.Index("store_hash"), storeHash)));
  return record.data;
}
async function deleteRecord(faunadbClient, storeHash) {
  console.log(`Deleting store app record for ... ${storeHash}`);
  const x = await faunadbClient.query(q.Get(q.Match(q.Index("store_hash"), storeHash)));
...
/* harmony import */ var _bigcommerce_app__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./bigcommerce/app */ "./bigcommerce/app/index.ts");
...
exports.handler = async (event, context, callback) => {
  try {
    ...
    const storeData = await _bigcommerce_app__WEBPACK_IMPORTED_MODULE_2__["repository"].fetchRecord(faunadbClient, payload.store_hash);

    try {
      _auth__WEBPACK_IMPORTED_MODULE_3__["auth"].verify(event.headers.cookie);
      return {
        statusCode: 302,
        headers: {
      ...
      return {
        ...
        headers: {
          ...
          'Set-Cookie': _auth__WEBPACK_IMPORTED_MODULE_3__["auth"].generateCookie(storeData.store_hash, storeData.access_token),
          'Location': process.env.URL
        },
        body: ""
      };
