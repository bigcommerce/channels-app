...
/******/ 	return __webpack_require__(__webpack_require__.s = "./bigcommerce_sites.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var _bigcommerce_sites__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./bigcommerce/sites */ "./bigcommerce/sites/index.ts");
/* harmony import */ var _auth__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./auth */ "./auth/index.ts");
...
exports.handler = async (event, context, callback) => {
  try {
    const session = _auth__WEBPACK_IMPORTED_MODULE_2__["auth"].verify(event.headers.cookie);
    ...
    if (event.httpMethod === "GET") {
      const data = await _bigcommerce_sites__WEBPACK_IMPORTED_MODULE_1__["repository"].fetchAll(bigCommerce);
      return {
        statusCode: 200,
