...
/******/ 	return __webpack_require__(__webpack_require__.s = "./bigcommerce_channels_channel.ts");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _repository__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./repository */ "./bigcommerce/channels/repository.ts");
...
/***/ "./bigcommerce/channels/repository.ts":
/*!********************************************!*\
  !*** ./bigcommerce/channels/repository.ts ***!
  \********************************************/
/*! exports provided: fetchAll, fetchChannel, createChannel, updateChannel */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function fetchChannel(bigCommerceClient, channelId) {
  return bigCommerceClient.get(`/channels/${channelId}`);
}
function createChannel(bigCommerceClient, externalId, isEnabled, channelName, channelPlatform, channelType) {
...
function updateChannel(bigCommerceClient, channelId, channelName, externalId, isEnabled) {
...
/***/ "./bigcommerce_channels_channel.ts":
/*!*****************************************!*\
  !*** ./bigcommerce_channels_channel.ts ***!
  \*****************************************/
/*! no exports provided */
...
/* harmony import */ var _bigcommerce_channels__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./bigcommerce/channels */ "./bigcommerce/channels/index.ts");
...
exports.handler = async (event, context, callback) => {
  try {
    ...
    if (event.httpMethod === "GET") {
      const data = await _bigcommerce_channels__WEBPACK_IMPORTED_MODULE_2__["repository"].fetchChannel(bigCommerce, event.queryStringParameters.channel_id);
    ...
    if (event.httpMethod === "PUT") {
      ...
      const data = await _bigcommerce_channels__WEBPACK_IMPORTED_MODULE_2__["repository"].updateChannel(bigCommerce, payload.channel_id, payload.channel_name, payload.external_id, payload.is_enabled);
      console.log(JSON.stringify(data, null, 2)); // const data = {}
